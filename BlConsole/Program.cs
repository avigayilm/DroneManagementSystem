                                ...
                                switch (entityOption)//what entity to add
                                {
                                    case EntityOptions.Station://add station
                                        {
                                            ...
                                            Station tempStat = new Station()// adds a new station
                                            {
                                                ...
                                                Loc = new Location() { Longitude = longitudeInput, Latitude = latitudeInput },
                                                Charging = new List<DroneInCharge>()
                                            };
                                    ...
                                    case EntityOptions.Parcel://adds a parcel
                                        
                                        {
                                            ...
                                            {
                                                Sender = new CustomerInParcel() { Id = inputSenderId },
                                                Receiver = new CustomerInParcel() { Id = inputTargetId },
                                                Weight = maxim,
                                                Priority = prio,
                                            };
