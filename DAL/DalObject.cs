    ...
    namespace DO
    {
        ...
        public class DalObject
        {
            ...
            public void ParcelDrone(int ParcelId)
            {
                ...
                DataSource.ParcelArr[index].DroneId = DataSource.DronesArr[j].ID;
            }
            ...
            public void BatteryCharged(DroneCharge Buzzer)
            {
                ...
                DataSource.StationArr[Buzzer.stationId].chargingSlots -= 1;
            ...
            {
                return DataSource.DroneArr[ID].ToString();
            }
            ...
            public string DecimalToSexagesimal(double coord, char latOrLot)
            {
                ...
                coord = coord * -1
                int deg = coord / 1;
                int min = ((coord % 1) * 60) / 1;
                double sec = (((coord % 1) * 60) % 1) * 60;
                string toReturn = deg + "° " + min + $"' "   + sec '"' + direction + "\n";
                return toReturn;
            }
        }
