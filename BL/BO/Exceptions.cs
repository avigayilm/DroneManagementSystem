...
namespace BO
{
    ...
    [Serializable]
    public class LoginBLException : Exception
    {
        public LoginBLException() : base()
        {
        }

        public LoginBLException(string message) : base("LoginException: " + message)
        {
        }

        public LoginBLException(string message, Exception innerException) : base(message, innerException)
        {
        }
