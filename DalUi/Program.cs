                                ...
                                case EntityOptions.Drone://adds drone
                                    {
                                        ...
                                        Console.WriteLine("Enter the Id, model, weightcategory(0-2)");
                    ...
                    case MenuOptions.Update://update existing entities
                        {
                            ...
                            switch (updateOption)
                            {
                                ...
                                case UpdateOptions.Delivery://adds a delivery of parcel by drone
                                    {
                                        Console.WriteLine("Enter the parcelid\n");
                    ...
                    case MenuOptions.Show_Distance://to show distance between a point and a station/cusomer
                        {
                            ...
                            double distance = global::Bonus.Haversine(custOrStat.Longitude, custOrStat.Latitude, lonP, latP);
                            Console.WriteLine($"The distance is: {distance} KM");//calls haversine function from bonus library
